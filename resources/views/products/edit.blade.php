                            ...
                            <div class="card mt-1">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" value="{{$product->name}}" class="form-control"  placeholder="Input data">
                                    </div>

                                    <div class="form-group">
                                        <label for="name">Price</label>
                                        <input type="text" name="price" value="{{$product->price}}" class="form-control" placeholder="Input data">
                                    </div>

                                    <div class="form-group">
                                        <label for="name">Unit</label>
                                        <input type="text" name="unit" value="{{$product->unit}}" class="form-control" placeholder="Input data">
                                    </div>
